...
//        }
        ...
        new GithubQueryTast().equals(githubSearchUrl);
    ...
    public class GithubQueryTast extends AsyncTask<URL, Void, String>{

        @Override
        protected String doInBackground(URL... urls) {
            URL searchUrl = urls[0];
            //passing kedalam NetwordkUtils.getRespondFromHttpUrl
